...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="<?php echo base_url($themes . 'bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css'); ?>" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <!--link href="<?php echo base_url($themes . 'bower_components/datatables-responsive/css/dataTables.responsive.css'); ?>" rel="stylesheet"-->
    ...
    <script src="<?php echo base_url($themes . 'bower_components/datatables/media/js/jquery.dataTables.min.js'); ?>"></script>
    <script src="<?php echo base_url($themes . 'bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js'); ?>"></script>
...
<body>
    ...
    <div id="wrapper">
    	...
    	<?php $this->load->view('sadmin/includes/nav', array('themes' => $themes))?>
