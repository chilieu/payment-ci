...
<head>
    ...
    <meta name="keyword" content="CloudBerry Soft, build website, awesome custom app, premium software, Wordpress">
        ...
        <div class="header-overlay">
            <div class="container">
                ...
                <div data-scroll-reveal="enter top and move 50px over 1.2s" class="hexagon">
                    <i class="fa fa-cloud"></i><span></span>
                </div>
                <!-- Logo Ends -->
                <!-- Main Heading Starts -->
                <div class="main-head">
                    <h2 data-scroll-reveal="enter left and move 50px over 1.8s">
                        CloudBerry Hosting</h2>
                    <p data-scroll-reveal="enter right and move 50px over 2.0s">
                        Build Website with Shared Hosting<br>Great for Small to Midsize Business</p>
                </div>
                <!-- Main Heading Ends -->
            </div>
    ...
    <section id="services">
        <div class="services-overlay">
            <div class="container">
                <!-- Main Heading Starts -->
                <div class="main-head">
                    <h2 data-scroll-reveal="enter top and move 50px over 1.2s">Who We Are</h2>
					<h5 data-scroll-reveal="enter bottom and move 50px over 1.4s">
                        CloudBerry is a small group of dedicated Knights working hard around the table and
                        the clock.</h5>
                    <br />
                    <p data-scroll-reveal="enter bottom and move 50px over 1.4s">
                         We Use The Latest Technology to make Powerful Web sites and online applications which don't require labour instensive and error prone HTML entry for individual pages.
        ...
        <div class="container">
            ...
            <div data-scroll-reveal="enter bottom and move 50px over 1.2s">
                <p data-scroll-reveal="enter over 3.2s">
                    &copy <a href="http://www.cloudberrysoft.com">
                        http://www.cloudberrysoft.com</a>
                </p>
            </div>
            <!-- Copyright Ends -->
        </div>
