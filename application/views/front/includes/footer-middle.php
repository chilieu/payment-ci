        ...
        <div class="row add-clearfix same-height">
          ...
          <div class="col-sm-6 col-md-3">
            ...
            <ul class="recent-posts">
              <li> <a href="#" class="post-author-avatar"><span><img src="<?php echo base_url($themes . 'img/44x44-img1.jpg'); ?>" alt=""></span></a>
              ...
              <li> <a href="#" class="post-author-avatar"><span><img src="<?php echo base_url($themes . 'img/44x44-img2.jpg'); ?>" alt=""></span></a>
                <div class="post-content"> <a href="#" class="post-title">Aliquam hendrerit augu insuscipit ellentesqu </a>
                  <p>By <a href="#">Admin</a> .  12 Mar, 2015</p>
                </div>
              </li>
              <li> <a href="#" class="post-author-avatar"><span><img src="<?php echo base_url($themes . 'img/44x44-img3.jpg'); ?>" alt=""></span></a>
                <div class="post-content"> <a href="#" class="post-title">Aliquam hendrerit augu insuscipit ellentesqu </a>
                  <p>By <a href="#">Admin</a> .  12 Mar, 2015</p>
                </div>
              </li>
